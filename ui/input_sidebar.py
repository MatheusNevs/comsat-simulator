"""
Módulo de Barra Lateral Generativa de Parâmetros (ui/input_sidebar.py)

Renderiza formulários e controles de entrada de dados genéricos na barra lateral do Streamlit.
"""
...
def render_sidebar():
    """
    Renderiza os menus de entrada de dados de parâmetros do enlace na barra lateral
    e retorna um dicionário estruturado com as configurações informadas.

    Retorna:
        dict: Dicionário contendo os parâmetros de RF e geometria configurados pelo usuário.
    """
    ...
    with st.sidebar.expander("📡 Receptor (RX)", expanded=False):
        ...
        st.markdown("*Configurações de ruído e temperatura podem ser editadas diretamente no painel 3D.*")
